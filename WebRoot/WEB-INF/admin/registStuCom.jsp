...
<body>
	...
	<div class="updatestu_table_show">
		...
		<%
			...
			%>
		<center><hr>
		<form action="RegisterStuComCl?type=registComOk" method='post'>
			<table border="1">
				<tr>
					<td colspan="3">添加实习信息</td>
				</tr>
				<tr>
					<td>公司名</td>
					<td colspan="2">
				...
				<tr>
					...
					<input type="submit" onClick="return confirmOper3()"  value="提交"> <input type="reset" value="重设">
					</td>
				</tr>
