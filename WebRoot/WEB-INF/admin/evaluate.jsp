...
<link rel="stylesheet" type="text/css" href="css/comm.css">
  ...
  <hr>
	...
	<center><hr>
		...
		<form action="/Internship/EvaluationStuCl?type=Eva&stuId=<%=stuId %>" method="post">
		<table width="781" height="110">
			...
			<br/><br/><br/>
				...
				<td>评价:</td>
				<td><textarea rows="12" cols="80" name="evaluation" ></textarea>
				<center><br/><input type="submit" onClick="return confirmOper1()" value="提交"><input type="reset" value="清空"></center>
				</td>
			</tr>
