...
<html>
  <head>
    ...
    <title>My JSP 'updateEvaluate.jsp' starting page</title>
...
<link rel="stylesheet" type="text/css" href="css/comm.css">
  ...
  <hr>
	...
	<center><hr>
		...
		<form action="/Internship/EvaluationStuCl?type=updEva&stuId=<%=stuId %>" method="post">
		<table width="781" height="110">
			...
			<br/><br/><br/>
				...
				<td>修改评价:</td>
				<td><textarea rows="12" cols="80" name="evaluation" ><%=stu.getTecherevaluation()%></textarea>
				<center><br/><input type="submit" onClick="return confirmOper()6" value="提交"><input type="reset" value="重新修改"></center>
				</td>
			</tr>
