...
<title>My JSP 'writeResume.jsp' starting page</title>
...
<body>
	...
	<div class="stu_write_resume">
		...
		<div class="stu_person_info">
			<form action="/Internship/ExcuteCl?type=sumbitResume" method="post"
				...
				<table border="1" cellspacing="0">
					...
					<tr>
						...
						<td>籍贯</td>
						<td><input type="text" name="nativePlace" value="XX省XX市">
						</td>
					</tr>
					<tr>
						<td>出生年月</td>
						<td><input type="text" value="xxxx-xx-xx" name="birthday">
						</td>
						<td>毕业年份</td>
						<td><input type="text" name="graduationYear">
						</td>
					</tr>
					<tr>
						<td>学历</td>
						...
						<td>体重身高</td>
						<td><input type="text" name="hightweight" value="xxxcm,xxkg">
						</td>
					</tr>
					<tr>
						<td>毕业学校</td>
						<td><input type="text" name="graduationschool">
						</td>
						<td>希望工作地区</td>
						<td><input type="text" name="hopePlace">
						</td>
					</tr>
					<tr>
						<td>专业</td>
						...
						<td>健康状况</td>
						<td><input type="text" name="healthsituation">
						</td>
					</tr>
					<tr>
						<td>QQ</td>
						...
						<td>邮箱</td>
						<td><input type="text" name="poscalcode">
						</td>
					...
					<tr>
						<td>英语等级</td>
						<td><input type="text" name="englishClass">
						</td>
						<td>精通方向</td>
						<td colspan="2">
						<%
							ArrayList al=(ArrayList)request.getAttribute("directionInfo");
							for(int i=0;i<al.size();i++)
							{
									Professionaldirection pr=(Professionaldirection)al.get(i);
						 %>
					...
					<tr>
						<td>期望岗位</td>
						<td colspan="3"><textarea cols="72" rows="1" name="hopeJob"></textarea>
						</td>
					</tr>
					<tr>
						<td height=50 colspan="1">主修课程</td>
						<td colspan="4"><textarea cols="72" rows="4" name="major"></textarea>
						</td>
					</tr>
					<tr>
					<tr>
